...
#database connection
mydb=mysql.connector.connect(host="localhost",user="root",password="Rishi@123456789",database = "bday_data")
...
def send_whatsappmessage(data):
    name =data[0]
    number='+91'+data[2]
    img="C:\\Users\\Gauri Bhojane\\OneDrive\\Documents\\3rd_year\\SE\\birthday_img.jpg"
